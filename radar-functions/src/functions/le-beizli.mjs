...
const sauvageRegex = buildMenuRegex("sauvage", sauvageToken, [jardiniereToken, fraichetteToken, suessesSection, tellerSection, endToken])
const jardiniereRegex = buildMenuRegex("sauvage", jardiniereToken, [sauvageToken, fraichetteToken, suessesSection, tellerSection, endToken])
const fraichetteRegex = buildMenuRegex("sauvage", fraichetteToken, [sauvageToken, jardiniereToken, suessesSection, tellerSection, endToken])

const saladeRegex = buildMenuRegex("salade", saladeToken, [quicheToken, meatToken, pastaToken, vegiToken, dopaminToken, suessesSection, endToken])
const quicheRegex = buildMenuRegex("quiche", quicheToken, [meatToken, pastaToken, vegiToken, dopaminToken, suessesSection, endToken])
const pastaRegex = buildMenuRegex("pasta", pastaToken, [meatToken, quicheToken, vegiToken, dopaminToken, suessesSection, endToken])
const dopaminRegex = buildMenuRegex("dopamin", dopaminToken, [meatToken, pastaToken, vegiToken, quicheToken, suessesSection, endToken])
const meatRegex = buildMenuRegex("fleisch", meatToken, [dopaminToken, pastaToken, vegiToken, quicheToken, suessesSection, endToken])
const vegiRegex = buildMenuRegex("garten", vegiToken, [meatToken, quicheToken, pastaToken, dopaminToken, suessesSection, endToken])
